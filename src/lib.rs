...
pub struct ChipGenerationData {
	...
	pub generated: usize,
	/// How many frames were left in the tick when generation stopped.
...
impl ChipState {
	...
	/// then returns a struct containing information about how many frames it generated,
	/// and how many frames still need to be generated to complete a tick.
	/// 
	/// If the number of remaining frames is anything but zero, then the tick was not completed.
	...
	pub fn generate(&mut self, buffer: &mut [f32]) -> Result<ChipGenerationData, LSynthError> {
		...
		Ok(ChipGenerationData {generated: frames_to_generate, remaining_frames: self.remaining_frames.floor() as usize})
	}
